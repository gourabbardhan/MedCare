              ...
              <div className='col-bot'>
                ...
                <div className='col-bot-wrap'>
                  <div className='poer-bot'>
                    <Link to="/ourblog" className='poer-img'><img src="/MedCare/images/hol-6.jpg" alt="hol-6" /></Link>
                  ...
                  <div className='poer-bot'>
                    <Link to="/ourblog" className='poer-img'><img src="/MedCare/images/hol-1.jpg" alt="hol-1" /></Link>
                    <div className='poer-txt'>
                      <h5>March 18, 2024</h5>
                  ...
                  <div className='poer-bot'>
                    <Link to="/ourblog" className='poer-img'><img src="/MedCare/images/banner.jpg" alt="banner" /></Link>
                    <div className='poer-txt'>
                      <h5>March 18, 2024</h5>
                  ...
                  <div className='poer-bot'>
                    <Link to="/ourblog" className='poer-img'><img src="/MedCare/images/hol-5.jpg" alt="hol-5" /></Link>
                    <div className='poer-txt'>
                      <h5>March 18, 2024</h5>
